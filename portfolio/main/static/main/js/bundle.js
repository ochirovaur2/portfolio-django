...
function () {
  function TypeWriter(txtElement, words) {
    ...
    this.isDeleting = false; // Initial Type Speed

    this.typeSpeed = 300; // Current index of word
  ...
  _createClass(TypeWriter, [{
    key: "get_full_txt",
    value: function get_full_txt() {
      this.current = this.wordIndex % this.words.length; // Get full text of current word

      this.fullTxt = this.words[this.current];
    }
  }, {
    key: "add_or_remove_char",
    value: function add_or_remove_char() {
      if (this.isDeleting) {
        // Remove char
    ...
    value: function delete_chars() {
      ...
      if (!this.isDeleting && this.txt === this.fullTxt) {
        // Make pause at end
        this.typeSpeed = this.wait; // Set delete to true
    ...
    key: "type_first",
    value: function type_first() {
      var _this = this;

      this.get_full_txt();
      this.add_or_remove_char();
      setTimeout(function () {
        return _this.type_first();
      }, this.typeSpeed);
    }
  }, {
    key: "type",
...
function init() {
  ...
  (function () {
    var cover = document.querySelector('.cover-js');
    var page = document.querySelectorAll('.book__right.book__right_turn');
    setTimeout(function () {
  ...
  (function () {
    var turnPageBtn = document.querySelectorAll('.btn__change-page');
    turnPageBtn.forEach(function (el, index) {
      el.onclick = function (e) {
        var pageTurnId = el.getAttribute('data-page');
        if (!pageTurnId) return; // pause video when chang page
